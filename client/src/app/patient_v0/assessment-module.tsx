...
// export default function AssessmentModule({ userId }: { userId: string }) {
//   const [selectedAssessment, setSelectedAssessment] = useState<"phq9" | "gad7" | null>(null)
//   const [responses, setResponses] = useState<number[]>([])
//   const [score, setScore] = useState<number | null>(null)
//   const [isLoading, setIsLoading] = useState(false)

//   const questions = selectedAssessment === "phq9" ? PHQ9_QUESTIONS : GAD7_QUESTIONS
...
//             Consider discussing these results with your therapist to develop a personalized treatment plan.
//           </p>
...
//     <Card>
//       <CardHeader>
//         <CardTitle>{selectedAssessment === "phq9" ? "PHQ-9" : "GAD-7"} Assessment</CardTitle>
//         <CardDescription>Rate each statement from 0 (Not at all) to 3 (Nearly every day)</CardDescription>
//       </CardHeader>
...
//                     responses[index] === value ? "bg-primary text-primary-foreground" : "bg-muted hover:bg-muted/80"
//                   }`}
//                 >
//                   {value === 0 ? "Not" : value === 1 ? "Several" : value === 2 ? "More" : "Nearly"}
//                 </button>
//               ))}
//             </div>
//           </div>
