...
export default function MoodTracker({ userId }) {
  ...
  const [selectedMood, setSelectedMood] = useState(null); // Type annotation removed
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Track your mood to help us understand your mental health journey
          </CardDescription>
        </CardHeader>
